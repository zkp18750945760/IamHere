...
public class MePagerPresenter {
    ...
    public void upLoadHeadIcon(final Context context, String compressPath) {
        ...
        BaseApi.request(BaseApi.createApi(IMePagerApi.class).uploadHeadIcon(userBean.getUserId(), requestBody),
                new BaseApi.IResponseListener<UploadHeadIconBean>() {
                    ...
                    @Override
                    public void onFail() {
                        mePagerView.uploadHeadIconError(-1);
                        mePagerView.hideLoadingView();
                    }
                });
    }
     ...
     * @param userId 用户ID
     */
    public void getHeadIcon(Integer userId) {
        mePagerView.showLoadingView();
